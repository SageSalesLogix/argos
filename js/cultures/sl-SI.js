(function (factory) {
  ...
  Locale.addCulture('sl-SI', {
    ...
    messages: {
      ...
      'Bookmarked': {id: 'Bookmarked', value: 'Zaznamek ustvarjen', comment: 'Bookmark filled'},
      'BookmarkThis': {id: 'BookmarkThis', value: 'Ustvari zaznamek', comment: 'Bookmark outlined'},
      ...
      'GreaterOrEquals': {id: 'GreaterOrEquals', value: 'Večji ali enak', comment: 'Greater Or Equals in icons for filtering'},
      ...
      'JustifyCenter': {id: 'JustifyCenter', value: 'Na sredino', comment: 'justify text to center in the editor'},
      ...
      'LeftAlign': {id: 'LeftAlign', value: 'Poravnaj levo', comment: 'Left Align tooltip'},
      'LeftTextAlign': {id: 'LeftTextAlign', value: 'Besedilo poravnaj levo', comment: 'Left Text Align tooltip'},
      'LessOrEquals': {id: 'LessOrEquals', value: 'Manjši ali enak', comment: 'Less Or Equals in icons for filtering'},
      ...
      'MapPin': {id: 'MapPin', value: 'Preslikaj pin', comment: 'Map Pin tooltip'},
      ...
      'MultiselectWith': {id: 'MultiselectWith', value: '. Večkratna izbira s/z ', comment: 'the minutes portion of a time'},
      ...
      'OrderedList': {id: 'OrderedList', value: 'Urejen seznam', comment: 'Insert an Ordered list in the editor'},
      ...
      'PasswordValidation': {id: 'PasswordValidation', value: '<strong>Geslo:</strong><br>Mora biti dolgo vsaj 10 znakov<br>Mora vsebovati vsaj en velik znak<br>Mora vsebovati vsaj en mali znak<br><strong>Mora vsebovati vsaj en poseben znak</strong><br>Ne sme vsebovati vašega uporabniškega imena<br>Ne sme biti vaše predhodno uporabljeno geslo<br>', comment: 'Password validation requirements'},
      ...
      'PressDown': {id: 'PressDown', value: 'Pritisnite navzdol za izbiro datuma', comment: 'the audible label for Tooltip about how to operate the date picker'},
      ...
      'RightAlignText': {id: 'RightAlignText', value: 'Besedilo poravnaj desno', comment: 'Right Align Text tooltip'},
      ...
      'SearchFolder': {id: 'SearchFolder', value: 'Preišči mapo', comment: 'Search Folder tooltip'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: 'Razvrsti A do Ž', comment: 'Sort A to Z in icons for filtering'},
      'SortZtoA': {id: 'SortZtoA', value: 'Razvrsti Ž do A', comment: 'Sort Z to A in icons for filtering'},
      ...
      'Tack': {id: 'Tack', value: 'Žebljiček', comment: 'Tack tooltip'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: 'Neurejen seznam', comment: 'Insert an Unordered list in the editor'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: 'Navpična središčna poravnava', comment: 'Vertical Middle Align tooltip'},
