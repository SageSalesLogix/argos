(function (factory) {
  ...
  Locale.addCulture('ru-RU', {
    ...
    messages: {
      ...
      'BookmarkThis': {id: 'BookmarkThis', value: 'Добавить в закладки', comment: 'Bookmark outlined'},
      ...
      'GreaterOrEquals': {id: 'GreaterOrEquals', value: 'Больше чем или равняется', comment: 'Greater Or Equals in icons for filtering'},
      ...
      'LessOrEquals': {id: 'LessOrEquals', value: 'Меньше чем или равняется', comment: 'Less Or Equals in icons for filtering'},
      ...
      'NextMonth': {id: 'NextMonth', value: 'В следующем месяце', comment: 'the label for the button that moves calendar to next/prev'},
      ...
      'ToggleH4': {id: 'ToggleH4', value: 'Включить/выключить заголовок 3', comment: 'turn on and off heading 4 text'},
