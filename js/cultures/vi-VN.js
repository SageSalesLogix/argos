(function (factory) {
  ...
  Locale.addCulture('vi-VN', {
    ...
    messages: {
      ...
      'Bookmarked': {id: 'Bookmarked', value: 'Đã đánh dấu', comment: 'Bookmark filled'},
      'BookmarkThis': {id: 'BookmarkThis', value: 'Đánh dấu', comment: 'Bookmark outlined'},
      ...
      'GreaterOrEquals': {id: 'GreaterOrEquals', value: 'Lớn hơn hoặc bằng', comment: 'Greater Or Equals in icons for filtering'},
      ...
      'Info': {id: 'Info', value: 'Infor', comment: 'Info tooltip'},
      ...
      'JustifyCenter': {id: 'JustifyCenter', value: 'Căn giữa', comment: 'justify text to center in the editor'},
      ...
      'LeftAlign': {id: 'LeftAlign', value: 'Căn trái', comment: 'Left Align tooltip'},
      'LeftTextAlign': {id: 'LeftTextAlign', value: 'Căn trái văn bản', comment: 'Left Text Align tooltip'},
      'LessOrEquals': {id: 'LessOrEquals', value: 'Nhỏ hơn hoặc bằng', comment: 'Less Or Equals in icons for filtering'},
      ...
      'MapPin': {id: 'MapPin', value: 'Ghim bản đồ', comment: 'Map Pin tooltip'},
      'Maximize': {id: 'Maximize', value: 'Phóng to', comment: 'Maximize a screen or dialog in the UI'},
      'Median': {id: 'Median', value: 'Trung bình', comment: 'Median in Mathematics'},
      ...
      'MultiselectWith': {id: 'MultiselectWith', value: '. Chọn nhiều với ', comment: 'the minutes portion of a time'},
      ...
      'OrderedList': {id: 'OrderedList', value: 'Danh sách theo thứ tự', comment: 'Insert an Ordered list in the editor'},
      ...
      'PressDown': {id: 'PressDown', value: 'Nhấn Xuống để chọn một ngày', comment: 'the audible label for Tooltip about how to operate the date picker'},
      ...
      'Right': {id: 'Right', value: 'Phải', comment: 'Right tooltip'},
      'RightAlign': {id: 'RightAlign', value: 'Căn phải', comment: 'Right Align tooltip'},
      'RightAlignText': {id: 'RightAlignText', value: 'Căn phải văn bản', comment: 'Right Align Text tooltip'},
      ...
      'SortAtoZ': {id: 'SortAtoZ', value: 'Sắp xếp A đến Z', comment: 'Sort A to Z in icons for filtering'},
      'SortZtoA': {id: 'SortZtoA', value: 'Sắp xếp Z đến A', comment: 'Sort Z to A in icons for filtering'},
      ...
      'Tack': {id: 'Tack', value: 'Đinh ghim', comment: 'Tack tooltip'},
      ...
      'UnorderedList': {id: 'UnorderedList', value: 'Danh sách không theo thứ tự', comment: 'Insert an Unordered list in the editor'},
      ...
      'VerticalMiddleAlign': {id: 'VerticalMiddleAlign', value: 'Căn giữa theo chiều dọc', comment: 'Vertical Middle Align tooltip'},
